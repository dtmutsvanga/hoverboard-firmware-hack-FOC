...
// ################################# VARIANT_NUNCHUK SETTINGS ############################
  ...
  */
  ...
  #define PRI_INPUT1              2, -1024, -50, 1024, 20     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2              2, -1024, 0, 1024, 10     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
